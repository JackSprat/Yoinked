...
local function AddFrameBorders(frame)
...
local function CreateBGFrame(name, x, y, width, height)
    local frame = CreateFrame("Frame", name)
    frame:SetSize(width, height)
    frame:SetPoint("TOPLEFT", parent, "TOPLEFT", x, y)
    AddFrameBorders(frame)
...
local function CreateSimpleFrame(name, parent, x, y, width, height)
    local frame = CreateFrame("Frame", name, parent)
    frame:SetSize(width, height)
    frame:SetPoint("TOPLEFT", parent, "TOPLEFT", x, y)
    self:AddFrameBorders(frame)
    frame.texture = frame:CreateTexture()
    frame.texture:SetAllPoints(frame)
    frame.texture:SetColorTexture(0,0,0,0.1)
    frame:Hide()
    return frame
end
